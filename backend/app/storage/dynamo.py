...
# Capture Operations
def create_capture(data: CaptureData | None = None, **kwargs) -> dict[str, Any]:
    """
...
# Schedule Operations
def create_schedule(data: ScheduleData | None = None, **kwargs) -> dict[str, Any]:
    """
...
def delete_capture(capture_id: str, created_at: float | None = None) -> bool:
    """
